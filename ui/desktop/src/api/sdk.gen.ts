...
export const githubCopilotDeviceCode = <ThrowOnError extends boolean = false>(options?: Options<GithubCopilotDeviceCodeData, ThrowOnError>) => (options?.client ?? client).post<GithubCopilotDeviceCodeResponses, GithubCopilotDeviceCodeErrors, ThrowOnError>({ url: '/config/providers/github_copilot/oauth/device-code', ...options });

export const githubCopilotPollToken = <ThrowOnError extends boolean = false>(options: Options<GithubCopilotPollTokenData, ThrowOnError>) => (options.client ?? client).post<GithubCopilotPollTokenResponses, GithubCopilotPollTokenErrors, ThrowOnError>({
