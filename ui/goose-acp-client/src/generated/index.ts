...
export const GOOSE_EXT_METHODS = [
  ...
  {
    method: "_goose/unstable/session/cost/aggregate",
    requestType: "SessionCostAggregateRequest_unstable",
    responseType: "SessionCostAggregateResponse_unstable",
  },
] as const;
