...
#[openapi(
    paths(
        ...
        super::routes::copilot::review,
        super::routes::copilot::setup,
        super::routes::copilot::disconnect,
        super::routes::copilot::get_status,
        super::routes::copilot::comment,
        super::routes::copilot::get_prefs,
        super::routes::copilot::put_prefs,
        super::routes::copilot::get_repos,
        super::routes::copilot::get_analytics,
    ...
    components(schemas(
        ...
        goose::copilot::CopilotReviewRequest,
        goose::copilot::CopilotReviewResponse,
        goose::copilot::CopilotSetupResponse,
        goose::copilot::CopilotStatusResponse,
        goose::copilot::CopilotDisconnectResponse,
        goose::copilot::CopilotCommentRequest,
        goose::copilot::CopilotPrefsRequest,
        goose::copilot::CopilotPrefsResponse,
        goose::copilot::CopilotPrefs,
        goose::copilot::RoutingPrefs,
        goose::copilot::TriggerPreference,
        goose::copilot::TriggerPermission,
        goose::copilot::ReviewOutputStyle,
        goose::copilot::ReviewModelChoice,
        goose::copilot::ReviewSeverity,
        goose::copilot::CopilotRepo,
        goose::copilot::CopilotReposResponse,
        goose::copilot::RepoVisibility,
        goose::copilot::CopilotAnalytics,
