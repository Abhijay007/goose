...
#[openapi(
    ...
    components(schemas(
        ...
        super::routes::copilot::CopilotReviewRequest,
        super::routes::copilot::CopilotReviewResponse,
        super::routes::copilot::CopilotSetupResponse,
        super::routes::copilot::CopilotCommentRequest,
        super::routes::copilot::CopilotPrefsRequest,
        super::routes::copilot::CopilotPrefsResponse,
