...
#[openapi(
    paths(
        ...
        super::routes::config_management::github_copilot_device_code,
        super::routes::config_management::github_copilot_poll_token,
    ...
    components(schemas(
        ...
        super::routes::config_management::GithubDeviceCodeResponse,
        super::routes::config_management::GithubPollRequest,
